...
<body id="main_body" hidden>
    ...
    <div class="content_div">
	    ...
	    <a href="/Hospital_FP/controller?command=toAddNewUserForAdmin&statusAddUser=2"><div class="href_but blue_but"><fmt:message key='CREATE_NEW_PATIENCE'/></div></a>
		</div>
			        ...
			        <tr>
			            ...
			            <td>
			            	<form style="display: inline-block;" method="POST" action="/Hospital_FP/controller">
			            		...
			            		<input type="submit" class="table_but green_but" value="<fmt:message key='CREATE_WAY'/>">
			            	</form>
			            	<form style="display: inline-block;" method="POST" action="/Hospital_FP/controller">
